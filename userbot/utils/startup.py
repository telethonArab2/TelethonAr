...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://telegra.ph/file/7fe6990ff2291b21af220.mp4", caption="**⎈ ⦙ تـمّ تـحديـث تليثـون العـرب ✓  :**  [ 7.3 ] \n \n**⎈ ⦙ للحصول على اوامر السورس أرسل :** (  `.الاوامر`  ) \n**⎈ ⦙ يحتاج لتفعيل اونلاين أو أرسل :** (  `.اوامري`  )\n\n**⎈ ⦙ القناة الرسمية : @E999G **\n**⎈ ⦙ فارات سورس تليثون  : @E999G **\n**⎈ ⦙ كلايش تليثون :  @qqqjbot**",                buttons=[(Button.url("مجموعه تليثون", "https://t.me/X888E"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
