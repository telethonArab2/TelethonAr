...
def build_keyboard(buttons):
    ...
    return keyb
@SU_SELVA.on(admin_cmd(pattern="وقتيه (\d*) ([\s\S]*)"))    
async def _(event):
...
async def all_groups_id(cat):
    ...
    return catgroups
@SU_SELVA.on(admin_cmd(pattern="ازاله التوجيه(?: |$)(.*)"))    
async def _(event):
    try:
        await event.delete()
...
@SU_SELVA.on(admin_cmd(pattern=f"{ALLGROUB} ?(.*)$"))    
...
async def getTranslate(text, **kwargs):
    ...
    for _ in range(10):
        try:
            ...
            await sleep(0.1)
    return result
@SU_SELVA.iq_cmd(incoming=True, groups_only=True)
async def _(event):
    if not CHAT_FLOOD:
        return
...
@SU_SELVA.on(admin_cmd(pattern=f"{ALLPRIVATE} ?(.*)$"))    
...
@SU_SELVA.on(admin_cmd(pattern="كتابه وهمي(?:\s|$)([\s\S]*)"))
...
@SU_SELVA.on(admin_cmd(pattern="تكرار (.*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="مؤقته (\d*) ([\s\S]*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="ترحيب(?:\s|$)([\s\S]*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="مسح الترحيبات(?: |$)(.*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="ترحيباتي(?: |$)(.*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="رساله الترحيب السابقه (تشغيل|ايقاف)$"))    
async def del_welcome(event):
...
@SU_SELVA.on(admin_cmd(pattern="موقع(?: |$)(.*)"))    
async def gps(event):
...
async def ocr_iqthon(filename, overlay=False,api_key="160984b1d988957", language="eng"):
    ...
    return r.json()
@SU_SELVA.on(admin_cmd(pattern="فيديو وهمي(?:\s|$)([\s\S]*)"))
async def _iq(iqthon):
    iq = iqthon.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
    ...
    async with iqthon.client.action(iqthon.chat_id, "record-video"):
        await asyncio.sleep(iq)
@SU_SELVA.on(admin_cmd(pattern="ازعاج(?: |$)(.*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="الغاء الازعاج( -a)?"))    
async def echo(event):
    input_str = event.pattern_match.group(1)
    if input_str:
        lecho = get_all_echos()
        ...
        try:
            ...
            await edit_or_reply(event, "**⎈ ⦙   تـم ايقاف وضـع الازعاج على الجميع بنجاح ✅**")
@SU_SELVA.on(admin_cmd(pattern="المزعجهم( -a)?$"))    
async def echo(event):  
    input_str = event.pattern_match.group(1)
    private_chats = ""
...
async def _iq(iqthon):
    ...
    async with iqthon.client.action(iqthon.chat_id, "record-audio"):
        await asyncio.sleep(iq)
@SU_SELVA.on(admin_cmd(pattern="تنظيف(?:\s|$)([\s\S]*)"))
...
@SU_SELVA.on(admin_cmd(pattern="لعب وهمي(?:\s|$)([\s\S]*)"))
async def _iq(iqthon):
    iq = iqthon.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
    ...
    async with iqthon.client.action(iqthon.chat_id, "game"):
        await asyncio.sleep(iq)  
@SU_SELVA.iq_cmd(pattern="قرائه(?:\s|$)([\s\S]*)",)
...
@SU_SELVA.on(admin_cmd(pattern="اضف رد ([\s\S]*)")) 
...
@SU_SELVA.on(admin_cmd(pattern="موقع وهمي(?:\s|$)([\s\S]*)"))
async def _iq(iqthon):
    iq = iqthon.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
    ...
    async with iqthon.client.action(iqthon.chat_id, "location"):
        await asyncio.sleep(iq)
@SU_SELVA.on(admin_cmd(pattern="جميع الردود(?: |$)(.*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="مسح رد ([\s\S]*)")) 
...
@SU_SELVA.on(admin_cmd(pattern="مسح جميع الردود(?: |$)(.*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="تكلم(?:\s|$)([\s\S]*)"))    
async def _(event):
    input_str = event.pattern_match.group(1)
    start = datetime.now()
    reply_to_id = await reply_id(event)
...
@SU_SELVA.on(admin_cmd(pattern="تحذير تكرار(?:\s|$)([\s\S]*)"))
async def _(event):
    input_str = event.pattern_match.group(1)
...
@SU_SELVA.on(admin_cmd(pattern="ترجمه ([\s\S]*)"))
async def _(event):
    input_str = event.pattern_match.group(1)
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
...
@SU_SELVA.on(admin_cmd(pattern=f"{FOTOSECRET}(?: |$)(.*)"))    
async def iq(event):
  ...
  await event.delete()
@SU_SELVA.on(admin_cmd(pattern="تاريخ الرساله(?: |$)(.*)"))    
async def _(event):
...
@SU_SELVA.on(admin_cmd(pattern="جهه اتصال وهمي(?:\s|$)([\s\S]*)"))
async def _iq(iqthon):
    iq = iqthon.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
    ...
    async with iqthon.client.action(iqthon.chat_id, "contact"):
        await asyncio.sleep(iq)  
@SU_SELVA.on(admin_cmd(pattern="ماركدون(?:\s|$)([\s\S]*)"))    
async def _(event):
    reply_to_id = await reply_id(event)
    ...
    await event.delete()
@SU_SELVA.on(admin_cmd(pattern="حذف(?:\s|$)([\s\S]*)"))
async def iq(cloneiq):  
    chat = await cloneiq.get_input_chat()
    msgs = []
    count = 0
    ...
    await sleep(5)
    await hi.delete()
@SU_SELVA.on(admin_cmd(pattern="معرفات 100(?: |$)(.*)"))
async def iq(iqthon):
    ...
    await iqthon.delete()
@SU_SELVA.on(admin_cmd(pattern="معرفات 200(?: |$)(.*)"))
async def iq(iqthon):
    mentions = iqthon.text[8:]
    chat = await iqthon.get_input_chat()
    ...
    await iqthon.client.send_message(iqthon.chat_id, mentions)
    await iqthon.delete()
@SU_SELVA.on(admin_cmd(pattern="تاك 200(?: |$)(.*)"))
async def iq(iqthon):
    mentions = iqthon.text[8:]
    chat = await iqthon.get_input_chat()
    async for x in iqthon.client.iter_participants(chat, 200):
    ...
    await iqthon.client.send_message(iqthon.chat_id, mentions)
    await iqthon.delete()
@SU_SELVA.on(admin_cmd(pattern="تاك 150(?: |$)(.*)"))
async def iq(iqthon):
    mentions = iqthon.text[8:]
    chat = await iqthon.get_input_chat()
    ...
    await iqthon.client.send_message(iqthon.chat_id, mentions)
    await iqthon.delete()
@SU_SELVA.on(admin_cmd(pattern="تاك 100(?: |$)(.*)"))
async def iq(iqthon):
    mentions = iqthon.text[8:]
    chat = await iqthon.get_input_chat()
    async for x in iqthon.client.iter_participants(chat, 100):
    ...
    await iqthon.client.send_message(iqthon.chat_id, mentions)
    await iqthon.delete()
@SU_SELVA.on(admin_cmd(pattern="تاك 50(?: |$)(.*)"))
async def iq(iqthon):
    mentions = iqthon.text[8:]
    chat = await iqthon.get_input_chat()
    ...
    await iqthon.client.send_message(iqthon.chat_id, mentions)
    await iqthon.delete()
@SU_SELVA.on(admin_cmd(pattern="تاك 10(?: |$)(.*)"))
async def iq(iqthon):
    mentions = iqthon.text[8:]
    chat = await iqthon.get_input_chat()
    ...
    await iqthon.client.send_message(iqthon.chat_id, mentions)
    await iqthon.delete()
@SU_SELVA.on(admin_cmd(pattern="احسب ([\s\S]*)"))    
...
@SU_SELVA.iq_cmd(pattern="(ازاله الخلفيه بالملصق|ازاله الخلفيه)(?:\s|$)([\s\S]*)",)
async def remove_iq(event):
    ...
    await catevent.delete()
@SU_SELVA.on(admin_cmd(pattern="ابلاغ الادمنيه(?: |$)(.*)"))    
async def iq(event):
...
async def on_new_message(event):
    ...
    for snip in snips:
        ...
        if re.search(pattern, name, flags=re.IGNORECASE):
            ...
            break
@SU_SELVA.on(admin_cmd(pattern="خط ملصق ?(?:(.*?) ?; )?([\s\S]*)"))    
async def sticklet(event):
    ...
    try:
        ...
        pass
@SU_SELVA.on(admin_cmd(pattern="ضفدع(?:\s|$)([\s\S]*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="منع(?:\s|$)([\s\S]*)"))    
async def _(event):
    text = event.pattern_match.group(1)
...
@SU_SELVA.on(admin_cmd(pattern="الغاء منع(?:\s|$)([\s\S]*)"))    
async def _(event):
    text = event.pattern_match.group(1)
...
@SU_SELVA.on(admin_cmd(pattern="قائمه المنع$"))    
async def _(event):
...
@SU_SELVA.on(admin_cmd(pattern="مسح(\s*| \d+)$"))
async def iq(msg1):
    ...
    if iq_src:
        ...
        await msg1.delete()
@SU_SELVA.on(admin_cmd(pattern="تاك بالكلام ([\s\S]*)"))    
async def iq(event):
...
@SU_SELVA.on(admin_cmd(pattern="لافته(?:\s|$)([\s\S]*)"))    
...
@SU_SELVA.on(admin_cmd(pattern="نسخ(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
...
@SU_SELVA.on(admin_cmd(pattern="غمق(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
    if nshkh.reply_to_msg_id:
        ...
        await nshkh.edit("**⎈ ⦙   قم  برد على الرساله ** ")
@SU_SELVA.on(admin_cmd(pattern="ينسخ(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
    if nshkh.reply_to_msg_id:
        ...
        await nshkh.edit("**⎈ ⦙   قم  برد على الرساله ** ")
@SU_SELVA.on(admin_cmd(pattern="خط سفلي(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
    if nshkh.reply_to_msg_id:
