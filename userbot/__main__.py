...
def start_bot():
  try:
    ...
    iqthon.loop.run_until_complete(iqthon(functions.channels.JoinChannelRequest("s_ioc")))
    iqthon.loop.run_until_complete(iqthon(functions.channels.JoinChannelRequest("mega_saedd")))
  except Exception as e:
    print(e)
    return False
Checker = start_bot()
