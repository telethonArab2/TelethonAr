...
@SU_SELVA.iq_cmd(pattern="تكرار حزمه الملصقات$",)
...
@SU_SELVA.iq_cmd(    pattern="تكرار_احرف ([\s\S]*)",)
...
@SU_SELVA.iq_cmd(    pattern="تكرار_كلمه ([\s\S]*)",)
async def tmeme(event):
...
@SU_SELVA.iq_cmd(pattern=f"{MUQT} ([\s\S]*)",)
