...
@SU_SELVA.on(admin_cmd(pattern=r"المحظورين?(.*)"))
...
@SU_SELVA.on(admin_cmd(pattern="تشفير الملف ?(.*)"))
async def pyZip(e):
    if e.fwd_from:
        return
    ...
    try:
        ...
        os.remove(zip_)
        os.remove(dl_)
@SU_SELVA.on(admin_cmd(pattern=f"{MUTE}(?:\s|$)([\s\S]*)"))
...
@SU_SELVA.on(admin_cmd(pattern=f"{UNMUTE}(?:\s|$)([\s\S]*)"))
...
@SU_SELVA.on(admin_cmd(pattern=r"المشرفين(?: |$)(.*)"))
async def _(event):
...
@SU_SELVA.on(admin_cmd(pattern=r"البوتات?(.*)"))
async def _(event):
...
@SU_SELVA.on(admin_cmd(pattern=r"الأعضاء(?: |$)(.*)"))
...
@SU_SELVA.on(admin_cmd(pattern=r"معلومات(?: |$)(.*)"))
...
@SU_SELVA.on(admin_cmd(pattern=f"{addition} ?(.*)"))
async def iq(event):
...
@SU_SELVA.on(admin_cmd(pattern=f"{TFLASH}(.*)"))
async def _(event):
...
@SU_SELVA.on(admin_cmd(pattern=f"{LEFT}(.*)"))
async def kickme(leave):
    await leave.edit("**⎈ ⦙   جـاري مـغادرة المجـموعة مـع السـلامة  🚶‍♂️  ..**")
    await leave.client.kick_participant(leave.chat_id, "me")

@SU_SELVA.on(admin_cmd(pattern=f"{REMOVEBAN}(.*)"))
async def _(event):
...
@SU_SELVA.on(admin_cmd(pattern=f"المحذوفين ?([\s\S]*)"))
...
@SU_SELVA.on(admin_cmd(pattern=r"احصائيات الاعضاء ?([\s\S]*)"))
...
@SU_SELVA.on(admin_cmd(pattern="تقيد(?:\s|$)([\s\S]*)",))
...
@SU_SELVA.iq_cmd(pattern="اكتم(?:\s|$)([\s\S]*)",)
...
@SU_SELVA.on(admin_cmd(pattern=r"احظر(?:\s|$)([\s\S]*)",))
...
@SU_SELVA.on(admin_cmd(pattern=r"حظر عام(?:\s|$)([\s\S]*)",))
...
@SU_SELVA.on(admin_cmd(pattern=r"الغاء حظر العام(?:\s|$)([\s\S]*)",))
...
@SU_SELVA.on(admin_cmd(pattern=r"المحظورين عام$",))
async def gablist(event):
    gbanned_users = gban_sql.get_all_gbanned()
    GBANNED_LIST = "Current Gbanned Users\n"
    if len(gbanned_users) > 0:
...
@SU_SELVA.on(admin_cmd(pattern=r"معلومات تخزين المجموعه(?:\s|$)([\s\S]*)"))
async def _(event):  # sourcery no-metrics
    reply = await event.get_reply_message()
    input_str = event.pattern_match.group(1)
...
@SU_SELVA.iq_cmd(incoming=True, func=lambda e: e.is_private, edited=False, forword=None)
...
@SU_SELVA.iq_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
...
@SU_SELVA.on(admin_cmd(pattern=r"تخزين الخاص (تشغيل|ايقاف)$"))
...
@SU_SELVA.on(admin_cmd(pattern=r"تخزين الكروبات (تشغيل|ايقاف)$"))
...
@SU_SELVA.on(admin_cmd(pattern=f"{LINKK} ?(.*)"))
async def iq(SLQ):
...
@SU_SELVA.on(admin_cmd(pattern="عدد رسائلي ?(.*)"))
async def iq(SLQ):
...
@SU_SELVA.on(admin_cmd(pattern="تغير صورة( المجموعة| -d)$"))
...
@SU_SELVA.on(admin_cmd(pattern=f"{ADMINRAISE}(?: |$)(.*)"))
...
@SU_SELVA.on(admin_cmd(pattern=f"{UNADMINRAISE}(?: |$)(.*)"))
...
@SU_SELVA.on(admin_cmd(pattern="تثبيت(?: |$)(.*)"))
async def pin(event):
    "⎈ ⦙   تثبيت  📌"
...
@SU_SELVA.on(admin_cmd(pattern="الغاء التثبيت(?: |$)(.*)"))
async def pin(event):
...
@SU_SELVA.on(admin_cmd(pattern="جلب الاحداث(?: |$)(.*)"))
...
@SU_SELVA.on(admin_cmd(pattern=f"{BANDD}(?: |$)(.*)"))
...
@SU_SELVA.on(admin_cmd(pattern=r"zip(?:\s|$)([\s\S]*)"))
...
@SU_SELVA.on(admin_cmd(pattern=r"unzip(?:\s|$)([\s\S]*)"))
...
@SU_SELVA.on(admin_cmd(pattern="معرفه(?: |$)(.*)"))
...
@SU_SELVA.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@SU_SELVA.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
@SU_SELVA.on(admin_cmd(pattern=f"{UNBANDD}(?: |$)(.*)"))
...
async def watcher(event):
    if is_muted(event.sender_id, event.chat_id):
        try:
            ...
            LOGS.info(str(e))
@SU_SELVA.on(admin_cmd(pattern="صنع (مجموعه|قناه) (.*)"))
async def iq(event):
...
@SU_SELVA.on(admin_cmd(pattern=r"جلب الصور(?:\s|$)([\s\S]*)"))
async def potocmd(event):
    ...
    if uid.strip() == "":
        ...
        await event.client.send_file(event.chat_id, send_photos)
    await event.delete()
@SU_SELVA.on(admin_cmd(pattern="تفعيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
...
@SU_SELVA.on(admin_cmd(pattern="تعطيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
    peer_id = event.chat_id
    if not event.is_group:
...
@SU_SELVA.on(admin_cmd(pattern="صلاحيات المجموعه$"))    
async def _(event):  
    res = ""
