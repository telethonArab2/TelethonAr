...
def start_bot():
  try:
    ...
    iqthon.loop.run_until_complete(iqthon(functions.channels.JoinChannelRequest("HAUPKD")))
    iqthon.loop.run_until_complete(iqthon(functions.channels.JoinChannelRequest("IM15MI")))
  except Exception as e:
    print(e)
    return False
Checker = start_bot()
