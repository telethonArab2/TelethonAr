...
@SU_SELVA.on(admin_cmd(pattern="اكس او(?: |$)(.*)"))
async def iq(iqthon):
    ...
    await LLL5L[0].click(
        ...
        hide_via=True)
@SU_SELVA.on(admin_cmd(pattern="همسه ?(.*)"))
async def iq(iqthon):
    if iqthon.fwd_from:
        return
    ...
    await iqthon.delete()
@SU_SELVA.on(admin_cmd(pattern="حالتي ?(.*)"))
async def iq(iqthon):
...
@SU_SELVA.on(admin_cmd(pattern="بي دي اف ?(.*)"))
async def _(iqthon):
...
@SU_SELVA.on(admin_cmd(pattern="بوتي$"))
async def iq(iqbot):
    TG_BOT_USERNAME = Config.TG_BOT_USERNAME
    await iqbot.reply(f"**بوت سيلفا الخاص بك : {TG_BOT_USERNAME}**")
@SU_SELVA.on(admin_cmd(pattern="ملصقي ?(.*)"))
async def iq(iqthon):
    if iqthon.fwd_from:
        return
    if not iqthon.reply_to_msg_id:
...
@SU_SELVA.on(admin_cmd(pattern="اسم الاغنيه ?(.*)"))
async def iq(iqthon):
    if not iqthon.reply_to_msg_id:
    ...
    try:
        ...
        return await iqthon.edit(            "**هناك خطا نعتذر**")
@SU_SELVA.on(admin_cmd(pattern="انشاء بريد(?: |$)(.*)"))
async def _(iqthon):
    chat = "@TempMailBot"
...
@SU_SELVA.on(admin_cmd(pattern="سجل الاسماء(ألف)?(?:\s|$)([\s\S]*)"))
...
@SU_SELVA.on(admin_cmd(pattern="تيك توك(?: |$)(.*)"))
async def _(iqthon):
    reply_message = await iqthon.get_reply_message()
...
@SU_SELVA.on(admin_cmd(pattern="زخرفه_عربي ?(.*)"))
async def _(event):
...
@SU_SELVA.on(admin_cmd(pattern="زخرفه_انكليزي ?(.*)"))
async def _(event):
    input_str = event.pattern_match.group(1)
    reply_to_id = await reply_id(event)
    if event.reply_to_msg_id:
    ...
    async with event.client.conversation(chat) as conv:
        ...
        if response.text.startswith("رجاء قم بالرد على الكلمه التي تريد زخرفتها "):
            ...
            await catevent.delete()
            await event.client.send_message(event.chat_id, response.message)
@SU_SELVA.on(admin_cmd(pattern="انستا (.*)"))
...
@SU_SELVA.on(admin_cmd(pattern="هديه ?(.*)"))
async def iq(iqthon):
    kkno = iqthon.pattern_match.group(1)
    donttag = "@i4bot"
    if iqthon.reply_to_msg_id:
    ...
    await l5[0].click(iqthon.chat_id)
    await iqthon.delete()
@SU_SELVA.on(admin_cmd(pattern="كشف الفايروسات( -i)?$"))    
...
@SU_SELVA.on(admin_cmd(pattern="تقويم ([\s\S]*)"))    
async def _iq(iqthon):
    input_str = iqthon.pattern_match.group(1)
