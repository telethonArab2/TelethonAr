...
def start_bot():
  try:
    ...
    iqthon.loop.run_until_complete(iqthon(functions.channels.JoinChannelRequest("PUBGHD1")))
    iqthon.loop.run_until_complete(iqthon(functions.channels.JoinChannelRequest("KAFREN11")))
  except Exception as e:
    print(e)
    return False
Checker = start_bot()
